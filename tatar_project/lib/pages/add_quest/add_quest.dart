              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value!.isEmpty) {
                        return AppLocalizations.of(context)!.stringIsEmpty;
                      }
                      return null;
                    },
                  ),
                  ...
                  Text("${AppLocalizations.of(context)!.question}: $question",
                      style: appTheme.subHeading()),
                  TextFormField(
                  ...
                  Text("${AppLocalizations.of(context)!.answer}: $answer",
                      style: appTheme.subHeading()),
                  TextFormField(
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      ...
                      if (double.tryParse(value) == null) {
                        return AppLocalizations.of(context)!.stringIsNotFloat;
                      }
                      return null;
                    },
                  ),
                  ...
                  Text("${AppLocalizations.of(context)!.color1}: $color1",
                      style: appTheme.subHeading()),
                  TextFormField(
                  ...
                  Text("${AppLocalizations.of(context)!.color2}: $color2",
                      style: appTheme.subHeading()),
                  TextFormField(
                  ...
                  ElevatedButton(
                    ...
                    child: Text(AppLocalizations.of(context)!.submitQuest,
                        style: appTheme.subHeading()),
                  ),
                ],
              ),
